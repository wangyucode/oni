...
export default function About() {
    ...
    return (
        <View className='root'>
            ...
            <Cell.Group>
                <Cell title="更新日志" extra={<ArrowRight />} onClick={handleLogClick} />
                <Cell title="支持运营" extra={<ArrowRight />} onClick={handleSupportClick} />
            </Cell.Group>
            <Tabbar fixed onSwitch={handleSwitchTab} defaultValue={1}>
                <Tabbar.Item title="产物计算" icon={<Icon name='refineDisabled' width={24} height={24} />} />
                <Tabbar.Item title="关于" icon={<Icon name='idea' width={24} height={24} />} />
            </Tabbar>
        </View>
    )
}